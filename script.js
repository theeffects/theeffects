...
if (phoneInput) {
  ...
  const caseDescriptions = [
    ...
    { title: "Холодные фонтаны", text: "Установка 12 холодных фонтанов по периметру сцены для эффектного открытия мероприятия. Безопасный дым и яркие визуальные эффекты." },
