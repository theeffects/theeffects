...
if (phoneInput) {
  ...
  const caseDescriptions = [
    { title: "Фотобудка на мероприятии", text: "Стильная фотобудка с мгновенной печатью фотографий. Гости получают яркие снимки с индивидуальным дизайном рамки, а вы — полную цифровую галерею всех фотографий."},
    { title: "Конфетти пушка", text: "Яркий залп конфетти для эффектного финала. Разноцветные ленты создают праздничную атмосферу и незабываемые эмоции для гостей." },
    { title: "Шампанское шоу", text: "Эффектная подача шампанского с сухим льдом и дымом. Идеальная пирамида из бокалов для главного момента торжества. Невероятные фото и эмоции гостей."}
    { title: "Фейерверк", text: "Яркий фейерверк в честь молодоженов. Зрелищное завершение свадебного вечера. Безопасные салюты для помещений и открытых площадок." },
    { title: "Фонтаны на свадьбе", text: "Холодные фонтаны создадут волшебную дорожку для молодоженов. Безопасные искры высотой до 3 метров. Идеально для первого танца." },
    { title: "Тяжелый дым", text: "Профессиональные дымовые машины с тяжёлым дымом для создания атмосферы на музыкальном фестивале. Полная синхронизация с выступлением артистов." }
  ];
